...
local MASTER_DB = {
    ...
    { id=23123, name="Blessed Wizard Oil (MH)", icon="inv_potion_138", bufficon="temp", checkTooltip="Blessed Wizard Oil" },
    { id=23123, name="Blessed Wizard Oil (OH)", icon="inv_potion_138", bufficon="temp", checkTooltip="Blessed Wizard Oil" },
